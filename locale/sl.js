const messages = {
    ...
    ip: (field) => `Vrednost ${field} mora biti ustrezen IP naslov.`,
    max: (field, [length]) => `Dolžina ${field} ne sme biti večja od ${length} znakov.`,
    ...
    min: (field, [length]) => `Dolžina ${field} mora biti vsaj ${length} znakov.`,
