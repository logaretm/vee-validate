const messages = {
    ...
    confirmed: (field, [confirmedField]) => `${field}의 항목이 ${confirmedField}와 일치하지 않습니다.`,
    ...
    digits: (field, [length]) => `${field}항목은 숫자이고 ${length}글자를 필요합니다.`,
    ...
    numeric: (field) => `${field}항목은 영문자이어야 합니다.`,
