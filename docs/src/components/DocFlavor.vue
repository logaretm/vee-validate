<template>
  <div class="mt-8">
    ...
    <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-8 text-white">
      <a :href="`/guide/components/${next}`" class="bg-gray-600 hover:bg-accent-900 p-6 rounded-lg relative">
      ...
      <a :href="`/guide/composition-api/${next}`" class="bg-gray-600 hover:bg-accent-900 p-6 rounded-lg relative">
