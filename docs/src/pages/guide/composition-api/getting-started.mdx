...
Similarly to HTML inputs, you can achieve the same results with the `defineComponentBinds` function. This function accepts a field path and returns an object containing the bindings for the component.
