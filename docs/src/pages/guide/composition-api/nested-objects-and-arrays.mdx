...
<Repl files={{ 'App.vue': 'CompositionNested01' }} client:only />
...
<Repl files={{ 'App.vue': 'CompositionNested02' }} client:only />
...
<Repl files={{ 'App.vue': 'CompositionNested03' }} client:only />
...
<Repl files={{ 'App.vue': 'CompositionNested04' }} client:only />
...
<Repl files={{ 'App.vue': 'CompositionNested05' }} client:only />
