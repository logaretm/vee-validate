...
it('adds a new error', () => {
    ...
    errors.add('name', 'The name is invalid', { name: 'rule1', params: [] });
...
it('adds a new error with a scope', () => {
    const errors = new ErrorBag();
    errors.add('name', 'The name is invalid', { name: 'rule1', params: [] }, 'scope1');
...
it('removes errors for a specific field', () => {
    const errors = new ErrorBag();
    errors.add('name', 'The name is invalid', { name: 'rule1', params: [] });
    errors.add('email', 'The email is invalid', { name: 'rule1', params: [] });
    errors.add('email', 'The email is shorter than 3 chars.', { name: 'rule1', params: [] });
...
it('removes errors for a specific field and scope', () => {
    const errors = new ErrorBag();
    errors.add('name', 'The name is invalid', { name: 'rule1', params: [] }, 'scope1');
    errors.add('email', 'The email is invalid', { name: 'rule1', params: [] }, 'scope1');
    errors.add('email', 'The email is shorter than 3 chars.', { name: 'rule1', params: [] }, 'scope2');
...
it('fetches the first error message for a specific field', () => {
    ...
    errors.add('email', 'This is the third rule', { name: 'rule2', params: [] });
    errors.add('email', 'This is the forth rule', { name: 'rule2', params: [] });
...
it('collects errors for a specific field and scope', () => {
    const errors = new ErrorBag();
    errors.add('email', 'The email is not email.', { name: 'rule1', params: [] }, 'scope1');
    errors.add('email', 'The email is invalid', { name: 'rule1', params: [] }, 'scope1');
    errors.add('email', 'The email is shorter than 3 chars.', { name: 'rule1', params: [] }, 'scope2');
...
it('can get a specific error message for a specific rule', () => {
    const errors = new ErrorBag();
    errors.add('name', 'The name is invalid', { name: 'rule1', params: [] });
    errors.add('name', 'The name is really invalid', { name: 'rule2', params: [] });
