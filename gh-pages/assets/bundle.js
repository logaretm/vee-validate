...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueValidation = __webpack_require__(9);

	var _vueValidation2 = _interopRequireDefault(_vueValidation);

	var _CodeExample = __webpack_require__(11);

	var _CodeExample2 = _interopRequireDefault(_CodeExample);

	var _Example = __webpack_require__(25);

	var _Example2 = _interopRequireDefault(_Example);

	var _Example3 = __webpack_require__(27);

	var _Example4 = _interopRequireDefault(_Example3);

	var _Example5 = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-1d4d452a/Example-1.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-1d5b5cab/Example-2.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
